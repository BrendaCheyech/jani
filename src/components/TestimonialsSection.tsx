      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">
            Used by Farms Ready to Lead in the Carbon Era
          </h2>
        ...
        <Card className="max-w-3xl mx-auto bg-white/70 backdrop-blur-sm border-white/60 rounded-3xl p-10 shadow-lg">
          <div className="text-center">
            <h3 className="text-xl font-bold text-primary mb-2">Wanjiku Farms</h3>
        ...
        <div className="max-w-4xl mx-auto mt-24">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-primary">Meet the Founder</h3>
          </div>
          
          <Card className="bg-white/70 backdrop-blur-sm border-white/60 rounded-3xl p-10 shadow-lg">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                <h4 className="text-2xl font-bold text-primary mb-2">Dr. Amara Okonkwo</h4>
                <p className="text-muted-foreground mb-6">Founder of Jani Intelligence</p>
              ...
              <div className="flex justify-center">
                <div className="w-64 h-64 rounded-3xl bg-gradient-to-br from-primary/20 to-purple-200/30 flex items-center justify-center">
